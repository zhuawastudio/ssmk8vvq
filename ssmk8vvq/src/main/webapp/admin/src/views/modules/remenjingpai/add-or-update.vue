  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="品牌" prop="pinpai">
              <el-input v-model="ruleForm.pinpai" 
                placeholder="品牌" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="球鞋状态" prop="qiuxiezhuangtai">
          <el-select v-model="ruleForm.qiuxiezhuangtai" placeholder="请选择球鞋状态">
            <el-option
                v-for="(item,index) in qiuxiezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="球鞋状态" prop="qiuxiezhuangtai">
	      <el-input v-model="ruleForm.qiuxiezhuangtai"
                placeholder="球鞋状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	clicknum : false,
            ...
            ruleForm: {
                  ...
                  jingpaidijia: [
                            { required: true, message: '竞拍底价不能为空', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  shishijiage: [
                            { required: true, message: '实时价格不能为空', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  xiangqing: [
                                    	                                                              ],
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pinpai = true;
            continue;
	            	            ...
	            	            if(o=='qiuxiezhuangtai'){
            this.ruleForm.qiuxiezhuangtai = obj[o];
	    this.ro.qiuxiezhuangtai = true;
            continue;
          }
	            	            if(o=='jingpaidijia'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.qiuxiezhuangtaiOptions = "竞拍中,已结束".split(',')
                                                                                                                                        },
                                                                                                                // 多级联动参数
                                                                                                                                              info(id) {
      this.$http({
        url: `remenjingpai/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `remenjingpai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.remenjingpaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
