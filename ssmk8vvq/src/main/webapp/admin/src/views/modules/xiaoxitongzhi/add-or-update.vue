      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="竞拍单号" prop="jingpaidanhao">
          <el-input v-model="ruleForm.jingpaidanhao" 
              placeholder="竞拍单号" clearable  :readonly="ro.jingpaidanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞拍单号" prop="jingpaidanhao">
              <el-input v-model="ruleForm.jingpaidanhao" 
                placeholder="竞拍单号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消息标题" prop="xiaoxibiaoti">
          <el-input v-model="ruleForm.xiaoxibiaoti" 
              placeholder="消息标题" clearable  :readonly="ro.xiaoxibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消息标题" prop="xiaoxibiaoti">
              <el-input v-model="ruleForm.xiaoxibiaoti" 
                placeholder="消息标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="收货地址" prop="shouhuodizhi">
              <el-input v-model="ruleForm.shouhuodizhi" 
                placeholder="收货地址" readonly></el-input>
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="消息内容" prop="xiaoxineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiaoxineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoxineirong" label="消息内容" prop="xiaoxineirong">
                    <span v-html="ruleForm.xiaoxineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingpaidanhao = true;
            continue;
	            	            ...
	            	            if(o=='xiaoxibiaoti'){
            this.ruleForm.xiaoxibiaoti = obj[o];
	    this.ro.xiaoxibiaoti = true;
            continue;
          }
	    ...
	    this.ro.yonghuchujia = true;
            continue;
	            	            ...
	            	            if(o=='xiaoxineirong'){
            this.ruleForm.xiaoxineirong = obj[o];
	    this.ro.xiaoxineirong = true;
            continue;
          }
