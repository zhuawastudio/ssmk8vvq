<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="竞拍单号" prop="jingpaidanhao">
            <el-input v-model="ruleForm.jingpaidanhao" 
                placeholder="竞拍单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jingpaidanhao" label="竞拍单号" prop="jingpaidanhao">
              <el-input v-model="ruleForm.jingpaidanhao" 
                placeholder="竞拍单号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="型号" prop="xinghao">
              <el-input v-model="ruleForm.xinghao" 
                placeholder="型号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞拍底价" prop="jingpaidijia">
          <el-input v-model="ruleForm.jingpaidijia" 
              placeholder="竞拍底价" clearable  :readonly="ro.jingpaidijia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞拍底价" prop="jingpaidijia">
              <el-input v-model="ruleForm.jingpaidijia" 
                placeholder="竞拍底价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实时价格" prop="shishijiage">
          <el-input v-model="ruleForm.shishijiage" 
              placeholder="实时价格" clearable  :readonly="ro.shishijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实时价格" prop="shishijiage">
              <el-input v-model="ruleForm.shishijiage" 
                placeholder="实时价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户出价" prop="yonghuchujia">
          <el-input v-model="ruleForm.yonghuchujia" 
              placeholder="用户出价" clearable  :readonly="ro.yonghuchujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户出价" prop="yonghuchujia">
              <el-input v-model="ruleForm.yonghuchujia" 
                placeholder="用户出价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="竞拍时间" prop="jingpaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jingpaishijian" 
                type="datetime"
                placeholder="竞拍时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jingpaishijian" label="竞拍时间" prop="jingpaishijian">
              <el-input v-model="ruleForm.jingpaishijian" 
                placeholder="竞拍时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='jingpaidanhao'){
            this.ruleForm.jingpaidanhao = obj[o];
	    this.ro.jingpaidanhao = true;
            continue;
          }
	    ...
	    this.ro.xinghao = true;
            continue;
	            	            ...
	            	            if(o=='jingpaidijia'){
            this.ruleForm.jingpaidijia = obj[o];
	    this.ro.jingpaidijia = true;
            continue;
          }
	            	            if(o=='shishijiage'){
            this.ruleForm.shishijiage = obj[o];
	    this.ro.shishijiage = true;
            continue;
          }
	            	            if(o=='yonghuchujia'){
            this.ruleForm.yonghuchujia = obj[o];
	    this.ro.yonghuchujia = true;
            continue;
          }
	            	            if(o=='jingpaishijian'){
            this.ruleForm.jingpaishijian = obj[o];
	    this.ro.jingpaishijian = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
                                                                                                                                                                        if(this.ruleForm.shishijiage>this.ruleForm.yonghuchujia){
        this.$message.error("实时价格不能超过用户出价");
        return
      }
