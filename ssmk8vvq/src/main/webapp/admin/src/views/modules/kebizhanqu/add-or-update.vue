<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="球鞋名称" prop="qiuxiemingcheng">
          <el-input v-model="ruleForm.qiuxiemingcheng" 
              placeholder="球鞋名称" clearable  :readonly="ro.qiuxiemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="球鞋名称" prop="qiuxiemingcheng">
              <el-input v-model="ruleForm.qiuxiemingcheng" 
                placeholder="球鞋名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shipin" label="视频" prop="shipin">
            <el-button type="text" size="small" @click="download(ruleForm.shipin)">预览</el-button>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="球鞋介绍" prop="qiuxiejieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiuxiejieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiuxiejieshao" label="球鞋介绍" prop="qiuxiejieshao">
                    <span v-html="ruleForm.qiuxiejieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            ruleForm: {
                	        qiuxiemingcheng: '',
	                        	        ...
	                        	        qiuxiejieshao: '',
                                                                                                                            ...
                                                                                                                            rules: {
                  qiuxiemingcheng: [
                            { required: true, message: '球鞋名称不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xinghao: [
                                    	                                                              ],
                  leixing: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='qiuxiemingcheng'){
            this.ruleForm.qiuxiemingcheng = obj[o];
	    this.ro.qiuxiemingcheng = true;
            continue;
          }
	            	            if(o=='xinghao'){
	    ...
	    this.ro.shipin = true;
            continue;
	            	            ...
	            	            if(o=='qiuxiejieshao'){
            this.ruleForm.qiuxiejieshao = obj[o];
	    this.ro.qiuxiejieshao = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kebizhanqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kebizhanquCrossAddOrUpdateFlag = false;
                  this.parent.search();
